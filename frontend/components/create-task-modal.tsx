...
export function CreateTaskModal({ isOpen, onClose }: CreateTaskModalProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Get NGO wallet address from profile or use a default
      const ngoWalletAddr = ngoProfile?.publicKey || ngoProfile?.walletAddress || "GBUQWP3BOUZX34ULNQG23RQ6F4BVXEYMJUCHUZI7VCZE7FDCVXWH6HUP"
